<template>
  <header id="header" class="bg-gray-700">
    <nav class="container mx-auto flex justify-start items-center py-5 px-4">
      <!-- App Name -->
      <router-link class="text-white font-bold uppercase text-2xl mr-4" exact-active-class="no-active" to="/">
        Music
      </router-link>
      ...
      <div class="flex flex-grow items-center">
        ...
        <ul class="flex flex-row mt-1">
          <!-- Navigation Links -->
           <li>
              <router-link class="px2 text-white" to="/about">About</router-link>
           </li>
